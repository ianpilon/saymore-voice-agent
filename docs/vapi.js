      ...
      !(function(e, t) {
        ...
        return (function() {
          var e = { 7: function(e2) {
            ...
            function C(e3) {
              return null != e3 && e3.callObjectBundleUrlOverride ? e3.callObjectBundleUrlOverride : A("https://c.daily.co/call-machine/versioned/".concat("0.80.0", "/static/call-machine-object-bundle.js"), e3);
            }
            function O(e3) {
              try {
                new URL(e3);
...
Reason: ${e4}`);
            ...
            var Za = {}, es = "video", ts = "voice", ns = Po() ? { data: {} } : { data: {}, topology: "none" }, rs = { present: 0, hidden: 0 }, is = { maxBitrate: { min: 1e5, max: 25e5 }, maxFramerate: { min: 1, max: 30 }, scaleResolutionDownBy: { min: 1, max: 8 } }, os = Object.keys(is), as = ["state", "volume", "simulcastEncodings"], ss = { androidInCallNotification: { title: "string", subtitle: "string", iconName: "string", disableForCustomOverride: "boolean" }, disableAutoDeviceManagement: { audio: "boolean", video: "boolean" } }, cs = { id: { iconPath: "string", iconPathDarkMode: "string", label: "string", tooltip: "string", visualState: "'default' | 'sidebar-open' | 'active'" } }, us = { id: { allow: "string", controlledBy: "'*' | 'owners' | string[]", csp: "string", iconURL: "string", label: "string", loading: "'eager' | 'lazy'", location: "'main' | 'sidebar'", name: "string", referrerPolicy: "string", sandbox: "string", src: "string", srcdoc: "string", shared: "string[] | 'owners' | boolean" } }, ls = { customIntegrations: { validate: Ds, help: Ls() }, customTrayButtons: { validate: Ns, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify(cs)) }, url: { validate: function(e3) {
              ...
              return Es(e3, { allowAllParticipantsKey: false });
            }, help: Is({ allowAllParticipantsKey: false }) }, sendSettings: { validate: function(e3, t3) {
              return !!(function(e4, t4) {
                try {
              ...
              var n3;
              return !!Ts(e3) && (t3._inputSettings || (t3._inputSettings = {}), Ms(e3, null === (n3 = t3.properties) || void 0 === n3 ? void 0 : n3.dailyConfig, t3._sharedTracks), t3._updatePreloadCacheInputSettings(e3, true), true);
            }, help: Ps() }, layout: { validate: function(e3) {
            ...
            var fs = (function(e3) {
              function t3(e4) {
                ...
                if (i(this, t3), o2 = this, a3 = l(a3 = t3), p(r2 = u(o2, Ka() ? Reflect.construct(a3, [], l(o2).constructor) : a3.apply(o2, s3)), "startListeningForDeviceChanges", (function() {
                  ...
                  r2.stopScreenShare();
                })), r2.strictMode = void 0 === d3.strictMode || d3.strictMode, r2.allowMultipleCallInstances = null !== (n4 = d3.allowMultipleCallInstances) && void 0 !== n4 && n4, Object.keys(Za).length && (r2._logDuplicateInstanceAttempt(), !r2.allowMultipleCallInstances)) {
              ...
              return f(t3, e3), c(t3, [{ key: "destroy", value: (te2 = v((function* () {
                ...
                return Ss(), this.sendMessageToCallMachine({ action: "load-css", cssFile: this.absoluteUrl(n4), bodyClass: t4, cssText: r2 }), this;
              } }, { key: "iframe", value: function() {
                return Ss(), this._iframe;
              } }, { key: "meetingState", value: function() {
                return this._callState;
              } }, { key: "accessState", value: function() {
                return _s(this._callObjectMode, "accessState()"), this._accessState;
                ...
                return _s(this._callObjectMode, "waitingParticipants()"), this._waitingParticipants;
                ...
                if (_s(this._callObjectMode, "updateWaitingParticipant()"), hs(this._callState, "updateWaitingParticipant()"), "string" != typeof t4 || "object" !== o(n4)) throw new Error("updateWaitingParticipant() must take an id string and a updates object");
                return new Promise((function(r2, i2) {
                ...
                if (_s(this._callObjectMode, "updateWaitingParticipants()"), hs(this._callState, "updateWaitingParticipants()"), "object" !== o(t4)) throw new Error("updateWaitingParticipants() must take a mapping between ids and update objects");
                ...
                return _s(this._callObjectMode, "requestAccess()"), hs(this._callState, "requestAccess()"), new Promise((function(t5, n5) {
                ...
                if (_s(this._callObjectMode, "getReceiveSettings()"), !this._callMachineInitialized) return this._receiveSettings;
                switch (o(e4)) {
                  case "string":
                ...
                var t4 = this;
                if (_s(this._callObjectMode, "updateReceiveSettings()"), !Es(e4, { allowAllParticipantsKey: true })) throw new Error(Is({ allowAllParticipantsKey: true }));
                return hs(this._callState, "updateReceiveSettings()", "To specify receive settings earlier, use the receiveSettings config property."), new Promise((function(n4) {
                ...
                var e4 = this;
                return Ss(), new Promise((function(t4) {
                ...
                var t4 = this;
                return Ss(), Ts(e4) ? e4.video || e4.audio ? (Ms(e4, this.properties.dailyConfig, this._sharedTracks), this._callObjectMode && !this._callMachineInitialized ? (this._updatePreloadCacheInputSettings(e4, true), this._getInputSettings()) : new Promise((function(n4, r2) {
                ...
                if (Ss(), this._callMachineInitialized) return this.sendMessageToCallMachine({ action: "set-bandwidth", kbs: t4, trackConstraints: n4 }), this;
              } }, { key: "getDailyLang", value: function() {
                var e4 = this;
                if (Ss(), this._callMachineInitialized) return new Promise((function(t4) {
                ...
                return Ss(), this.sendMessageToCallMachine({ action: "set-daily-lang", lang: e4 }), this;
                ...
                var e4 = this;
                return console.warn("getMeetingSession() is deprecated: use meetingSessionSummary(), which will return immediately"), hs(this._callState, "getMeetingSession()"), new Promise((function(t4) {
                ...
                return hs(this._callState, "meetingSessionState"), this._meetingSessionState;
              } }, { key: "setMeetingSessionData", value: function(e4) {
                var t4 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "replace";
                _s(this._callObjectMode, "setMeetingSessionData()"), hs(this._callState, "setMeetingSessionData");
                try {
                  !(function(e5, t5) {
                ...
                var e4 = this, t4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (_s(this._callObjectMode, "startCamera()"), gs(this._callState, this._isPreparingToJoin, "startCamera()", "Did you mean to use setLocalAudio() and/or setLocalVideo() instead?"), this.needsLoad()) try {
                  yield this.load(t4);
                } catch (e5) {
                ...
                return new Promise((function(t5) {
                  e4._preloadCache.inputSettings = e4._prepInputSettingsForSharing(e4._inputSettings, false), e4.sendMessageToCallMachine({ action: "start-camera", properties: ps(e4.properties, e4.callClientId), preloadCache: ps(e4._preloadCache, e4.callClientId) }, (function(e5) {
                ...
                return Ss(), hs(this._callState, "startCustomTrack()"), this.validateCustomTrack(t4.track, t4.mode, t4.trackName), new Promise((function(n4, r2) {
                ...
                var t4 = this;
                return Ss(), hs(this._callState, "stopCustomTrack()"), new Promise((function(n4) {
                ...
                var t4 = this;
                return ws(), ms(this._callMachineInitialized, "setCamera()"), new Promise((function(n4) {
                  t4.sendMessageToCallMachine({ action: "set-camera", cameraDeviceId: e4 }, (function(e5) {
                    n4({ device: e5.device });
                  }));
                }));
              } }, { key: "setAudioDevice", value: (q2 = v((function* (e4) {
                return ws(), this.nativeUtils().setAudioDevice(e4), { deviceId: yield this.nativeUtils().getAudioDevice() };
              })), function(e4) {
                return q2.apply(this, arguments);
                ...
                if (Ss(), void 0 !== i2 && (n4 = i2), void 0 !== o2 && (r2 = o2), "boolean" == typeof n4 && (this._setAllowLocalAudio(n4), n4 = void 0), "boolean" == typeof r2 && (this._setAllowLocalVideo(r2), r2 = void 0), !n4 && !r2) return yield this.getInputDevices();
                var a3 = {};
                ...
                return Ss(), n4 && (this._preloadCache.outputDeviceId = n4), this._callObjectMode && this.needsLoad() ? this._devicesFromInputSettings(this._inputSettings) : new Promise((function(e5) {
                  t4.sendMessageToCallMachine({ action: "set-output-device", outputDeviceId: n4 }, (function(n5) {
                    delete n5.action, delete n5.callbackStamp, n5.returnPreloadCache ? e5(t4._devicesFromInputSettings(t4._inputSettings)) : e5(n5);
                  }));
                }));
              })), function(e4) {
                ...
                return ws(), this._nativeInCallAudioMode;
              } }, { key: "setNativeInCallAudioMode", value: function(e4) {
                if (ws(), [es, ts].includes(e4)) {
                  if (e4 !== this._nativeInCallAudioMode) return this._nativeInCallAudioMode = e4, !this.disableReactNativeAutoDeviceManagement("audio") && vs(this._callState, this._isPreparingToJoin) && this.nativeUtils().setAudioMode(this._nativeInCallAudioMode), this;
                } else console.error("invalid in-call audio mode specified: ", e4);
              } }, { key: "preAuth", value: (B2 = v((function* () {
                var e4 = this, t4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (_s(this._callObjectMode, "preAuth()"), gs(this._callState, this._isPreparingToJoin, "preAuth()"), this.needsLoad() && (yield this.load(t4)), !t4.url) throw new Error("preAuth() requires at least a url to be provided");
                return this.validateProperties(t4), this.properties = Ha(Ha({}, this.properties), t4), new Promise((function(t5, n4) {
                  e4._preloadCache.inputSettings = e4._prepInputSettingsForSharing(e4._inputSettings, false), e4.sendMessageToCallMachine({ action: "daily-method-preauth", properties: ps(e4.properties, e4.callClientId), preloadCache: ps(e4._preloadCache, e4.callClientId) }, (function(r2) {
                ...
                return void 0 !== t4.showLocalVideo && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!t4.showLocalVideo), void 0 !== t4.showParticipantsBar && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!t4.showParticipantsBar), this._callState === Nr || this._callState === Lr ? (console.warn("already joined meeting, call leave() before joining again"), void this.updateIsPreparingToJoin(false)) : (this._updateCallState(Lr, false), this.emitDailyJSEvent({ action: bi }), this._preloadCache.inputSettings = this._prepInputSettingsForSharing(this._inputSettings || {}, false), this.sendMessageToCallMachine({ action: "join-meeting", properties: ps(this.properties, this.callClientId), preloadCache: ps(this._preloadCache, this.callClientId) }), new Promise((function(t5, r2) {
                ...
                var e4 = this, t4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (ms(this._callMachineInitialized, "startScreenShare()"), t4.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", t4.screenVideoSendSettings), t4.mediaStream && (this._sharedTracks.screenMediaStream = t4.mediaStream, t4.mediaStream = ko), "undefined" != typeof DailyNativeUtils && void 0 !== DailyNativeUtils.isIOS && DailyNativeUtils.isIOS) {
                ...
                ms(this._callMachineInitialized, "stopScreenShare()"), this.sendMessageToCallMachine({ action: "local-screen-stop" });
                ...
                if (e4) {
                  ...
                  if (!Fs(e4.length, 1, 3)) throw new Error("encodings must be an Array with between 1 to ".concat(3, " layers"));
                  for (var r2 = 0; r2 < e4.length; r2++) {
                    ...
                    for (var o2 in this._validateEncodingLayerHasValidProperties(i2), i2) if (os.includes(o2)) {
                      ...
                      if (t4) {
                        ...
                        if (!Fs(i2[o2], s3, c2)) throw new Error("".concat(o2, " value not in range. valid range: ").concat(s3, " to ").concat(c2));
                      }
                ...
                hs(this._callState, "startTranscription()"), this.sendMessageToCallMachine(Ha({ action: "daily-method-start-transcription" }, e4));
              } }, { key: "updateTranscription", value: function(e4) {
                if (hs(this._callState, "updateTranscription()"), !e4) throw new Error("updateTranscription Error: options is mandatory");
                ...
                if (hs(this._callState, "stopTranscription()"), e4 && "object" !== o(e4)) throw new Error("stopTranscription Error: options must be object type");
                ...
                var t4 = this;
                hs(this._callState, "startDialOut()");
                var n4 = function(e5) {
                  if (e5) {
                ...
                if (e4.permissions && e4.permissions.canReceive) {
                ...
                var t4 = this;
                return hs(this._callState, "stopDialOut()"), new Promise((function(n4, r2) {
                ...
                var t4 = this;
                if (hs(this._callState, "sipCallTransfer()"), !e4) throw new Error("sipCallTransfer() requires a sessionId and toEndPoint");
                return e4.useSipRefer = false, Rs(e4, "sipCallTransfer"), new Promise((function(n4, r2) {
                ...
                var t4 = this;
                if (hs(this._callState, "sipRefer()"), !e4) throw new Error("sessionId and toEndPoint are mandatory parameter");
                return e4.useSipRefer = true, Rs(e4, "sipRefer"), new Promise((function(n4, r2) {
                  t4.sendMessageToCallMachine(Ha({ action: Co }, e4), (function(e5) {
                    e5.error ? r2(e5.error) : n4(e5);
                  }));
                }));
                ...
                var t4 = this;
                return hs(this._callState, "sendDTMF()"), (function(e5) {
                ...
                var e4 = this;
                if (ys(this._testCallInProgress, "testWebsocketConnectivity()"), this.needsLoad()) try {
                  yield this.load();
                } catch (e5) {
                  return Promise.reject(e5);
                }
                ...
                var e4 = this;
                Ss(), _s(this._callObjectMode, "testCallQuality()"), ms(this._callMachineInitialized, "testCallQuality()", null, true), gs(this._callState, this._isPreparingToJoin, "testCallQuality()");
                ...
                var t4 = this;
                if (ys(this._testCallInProgress, "testPeerToPeerCallQuality()"), this.needsLoad()) try {
                  yield this.load();
                } catch (e5) {
                  return Promise.reject(e5);
                }
                ...
                var t4 = this;
                if (ys(this._testCallInProgress, "testNetworkConnectivity()"), this.needsLoad()) try {
                  yield this.load();
                } catch (e5) {
                  return Promise.reject(e5);
                }
                ...
                return Ss(), this.sendMessageToCallMachine({ action: "set-active-speaker-mode", enabled: e4 }), this;
                ...
                return hs(this._callState, "setSubscribeToTracksAutomatically()", "Use the subscribeToTracksAutomatically configuration property."), this._preloadCache.subscribeToTracksAutomatically = e4, this.sendMessageToCallMachine({ action: "daily-method-subscribe-to-tracks-automatically", enabled: e4 }), this;
                ...
                var t4 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "*";
                if (hs(this._callState, "sendAppMessage()"), JSON.stringify(e4).length > this._maxAppMessageSize) throw new Error("Message data too large. Max size is " + this._maxAppMessageSize);
                return this.sendMessageToCallMachine({ action: "app-msg", data: e4, to: t4 }), this;
              } }, { key: "addFakeParticipant", value: function(e4) {
                return Ss(), hs(this._callState, "addFakeParticipant()"), this.sendMessageToCallMachine(Ha({ action: "add-fake-participant" }, e4)), this;
              } }, { key: "setShowNamesMode", value: function(e4) {
                return bs(this._callObjectMode, "setShowNamesMode()"), Ss(), e4 && "always" !== e4 && "never" !== e4 ? (console.error('setShowNamesMode argument should be "always", "never", or false'), this) : (this.sendMessageToCallMachine({ action: "set-show-names", mode: e4 }), this);
              } }, { key: "setShowLocalVideo", value: function() {
                var e4 = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                return bs(this._callObjectMode, "setShowLocalVideo()"), Ss(), hs(this._callState, "setShowLocalVideo()"), "boolean" != typeof e4 ? (console.error("setShowLocalVideo only accepts a boolean value"), this) : (this.sendMessageToCallMachine({ action: "set-show-local-video", show: e4 }), this._showLocalVideo = e4, this);
              } }, { key: "showLocalVideo", value: function() {
                return bs(this._callObjectMode, "showLocalVideo()"), Ss(), this._showLocalVideo;
              } }, { key: "setShowParticipantsBar", value: function() {
                var e4 = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                return bs(this._callObjectMode, "setShowParticipantsBar()"), Ss(), hs(this._callState, "setShowParticipantsBar()"), "boolean" != typeof e4 ? (console.error("setShowParticipantsBar only accepts a boolean value"), this) : (this.sendMessageToCallMachine({ action: "set-show-participants-bar", show: e4 }), this._showParticipantsBar = e4, this);
              } }, { key: "showParticipantsBar", value: function() {
                return bs(this._callObjectMode, "showParticipantsBar()"), Ss(), this._showParticipantsBar;
              } }, { key: "customIntegrations", value: function() {
                return Ss(), bs(this._callObjectMode, "customIntegrations()"), this._customIntegrations;
              } }, { key: "setCustomIntegrations", value: function(e4) {
                return Ss(), bs(this._callObjectMode, "setCustomIntegrations()"), hs(this._callState, "setCustomIntegrations()"), Ds(e4) ? (this.sendMessageToCallMachine({ action: "set-custom-integrations", integrations: e4 }), this._customIntegrations = e4, this) : this;
              } }, { key: "startCustomIntegrations", value: function(e4) {
                var t4 = this;
                if (Ss(), bs(this._callObjectMode, "startCustomIntegrations()"), hs(this._callState, "startCustomIntegrations()"), Array.isArray(e4) && e4.some((function(e5) {
                ...
                var t4 = this;
                if (Ss(), bs(this._callObjectMode, "stopCustomIntegrations()"), hs(this._callState, "stopCustomIntegrations()"), Array.isArray(e4) && e4.some((function(e5) {
                  return "string" != typeof e5;
                ...
                return bs(this._callObjectMode, "customTrayButtons()"), Ss(), this._customTrayButtons;
              } }, { key: "updateCustomTrayButtons", value: function(e4) {
                return bs(this._callObjectMode, "updateCustomTrayButtons()"), Ss(), hs(this._callState, "updateCustomTrayButtons()"), Ns(e4) ? (this.sendMessageToCallMachine({ action: "update-custom-tray-buttons", btns: e4 }), this._customTrayButtons = e4, this) : (console.error("updateCustomTrayButtons only accepts a dictionary of the type ".concat(JSON.stringify(cs))), this);
              } }, { key: "theme", value: function() {
                return bs(this._callObjectMode, "theme()"), this.properties.theme;
              } }, { key: "setTheme", value: function(e4) {
                var t4 = this;
                return bs(this._callObjectMode, "setTheme()"), new Promise((function(n4, r2) {
                  try {
                ...
                if (Ss(), this._iframe && !document.fullscreenElement && Lo()) try {
                ...
                var t4 = this;
                return Ss(), hs(this._callState, "setNetworkTopology()"), new Promise((function(n4, r2) {
                ...
                if (Ss(), "number" != typeof e4 && true !== e4 && false !== e4) throw new Error("argument to setShouldPlayNewParticipantSound should be true, false, or a number, but is ".concat(e4));
                ...
                for (var u2 in e4) {
                  if (!ls[u2]) throw new Error("unrecognized property '".concat(u2, "'"));
                ...
                switch (e4.action) {
                  ...
                  case Oi:
                    ...
                    this._meetingSessionState = Vs(e4.meetingSessionState, this._callObjectMode), (this._callObjectMode || E2) && this.emitDailyJSEvent(e4);
                    break;
                  case Ki:
                ...
                if (e4 !== this._callState || t4 !== this._isPreparingToJoin) {
                  ...
                  var o2 = vs(n4, r2), a3 = vs(this._callState, this._isPreparingToJoin);
                ...
                if (Ss(), !e4 || !e4.contentWindow || "string" != typeof e4.src) throw new Error("DailyIframe::Wrap needs an iframe-like first argument");
                return n4.layout || (n4.customLayout ? n4.layout = "custom-v1" : n4.layout = "browser"), new t3(e4, n4);
              } }, { key: "createFrame", value: function(e4, n4) {
                var r2, i2;
                Ss(), e4 && n4 ? (r2 = e4, i2 = n4) : e4 && e4.append ? (r2 = e4, i2 = {}) : (r2 = document.body, i2 = e4 || {});
                ...
                switch (i2) {
                  ...
                  case "audio":
                    ...
                    for (var f2 = 0, p2 = Object.entries(a2); f2 < p2.length; f2++) {
                      ...
                      switch (v2) {
                        case "processor":
                          if (!As(g2)) return false;
                          break;
                        case "settings":
                          if (!Os(g2)) return false;
                          break;
                        default:
                          return false;
                      }
            ...
            function Ds(e3) {
              if (!e3 || e3 && "object" !== o(e3) || Array.isArray(e3)) return console.error(Ls()), false;
            ...
            function js(e3, t3) {
              ...
              switch (o(t3)) {
                ...
                case "object":
                  if ("object" !== o(e3)) return false;
                  for (var n3 in e3) if (!js(e3[n3], t3[n3])) return false;
                  return true;
                default:
                  return false;
              }
